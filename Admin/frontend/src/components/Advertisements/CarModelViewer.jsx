...
import { VolumeUp, PowerSettingsNew, Speed, ArrowDownward, ArrowUpward } from "@mui/icons-material";
...
// Main Component
export default function CarModelViewer({ model, audios, features }) {
  ...
  return (
    <ThemeProvider theme={theme}>
      <CssBaseline />
      <div style={{ position: "relative", height: "100vh", width: "100%", backgroundColor:theme.palette.background.paper }}>
        <CarCanvas
